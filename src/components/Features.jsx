        ...
        <div className="flex flex-col justify-center items-center overflow-hidden">
            ...
            <div className="flex-center flex-col sm:px-10">
                <div className="relative h-[50vh] w-full flex items-center mb-5 ">
                    <video playsInline id='exploreVideo' className="w-full h-full object-cover object-center rounded-t-3xl" preload='none' muted autoPlay loop ref={videoRef}>
                ...
                <div className="flex flex-col w-full relative">
                    ...
                    <div className="feature-text-container">
                        ...
                        <div className="flex-1 flex-center">
                            <p className="feature-text g_text">
                                Titanium has one of the best strength-to weight ratios of any metal these our {' '}
